...
## Download
### Windows and macOS
Download the latest release from [GitHub](https://github.com/rahulcvwebsitehosting/Open-Typer/releases/latest) or [SourceForge](https://sourceforge.net/projects/open-typer/).
...
Download the AppImage [here](https://github.com/rahulcvwebsitehosting/Open-Typer/releases/latest/download/Open-Typer-x86_64.AppImage) and make it executable:
